...
export function RecipeIngredients({
  ...
  return (
    <div className="px-2 pt-2 mt-5 md:ml-4 w-9/10 md:w-1/4 h-fit relative md:sticky md:top-5 rounded-md border-t-2 border-t-amber-600 shadow-md dark:shadow-xs dark:shadow-amber-600/30">
